...
open class SkyFloatingLabelTextField: UITextField { // swiftlint:disable:this type_body_length
    ...
    */
    ...
    override open func layoutSubviews() {
        ...
        // Foks modify -START-
        tintClearImage(color: clearButtonColor)
        // Foks modify -END-
    }
    ...
    /// A UIColor value that determines the color used for clear button.
    @IBInspectable dynamic open var clearButtonColor: UIColor = .lightGray {
        didSet {
            tintClearImage(color: clearButtonColor)
        }
    }
