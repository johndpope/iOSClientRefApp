...
open class McPicker: UIView {
    ...
    // Foks modify -START-
    fileprivate var selectionComponent = 0;
    fileprivate var selectionRow = 0;
    // Foks modify -END-
...
//        self.addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(cancel)))
    ...
    private func animateViews(direction:AnimationDirection){
        ...
        if direction == .in {
            ...
            // Foks modify -START-
            backgroundView.addSubview(defaultSelectionIndicator)
            // Foks modify -END-
    ...
    @objc private func sizeViews() {
        ...
        // Foks modify -START-
        defaultSelectionIndicator.frame = CGRect(x: 40,
                                                 y: 170,
                                                 width: backgroundView.bounds.size.width-40*2,
                                                 height: 1)
        // Foks modify -END-
    }
}
...
extension McPicker : UIPickerViewDelegate {
    public func pickerView(_ pickerView: UIPickerView, viewForRow row: Int, forComponent component: Int, reusing view: UIView?) -> UIView {
        ...
        // Foks modify -START-
        if self.selectionComponent == component && self.selectionRow == row {
            pickerLabel?.textColor = selectionIndicatorColor
        } else {
    ...
    public func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        ...
        // Foks modify -START-
        self.selectionComponent = component
